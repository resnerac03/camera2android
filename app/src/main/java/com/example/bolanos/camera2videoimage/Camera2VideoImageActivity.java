...
public class Camera2VideoImageActivity extends AppCompatActivity {
        ...
        mRecordImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mIsRecording){
                    ...
                    mIsRecording = false;
                    mRecordImageButton.setImageResource(R.mipmap.btn_video_online_web);
                    mMediaRecorder.stop();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION_RESULT){
            if(grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this,"Permission successfuly granted!",Toast.LENGTH_SHORT).show();
            }else{
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(previewSurface, recordSurface), new CameraCaptureSession.StateCallback() {
                ...
                public void onClosed(CameraCaptureSession session) {
                    ...
                    Intent previewVideoFile = new Intent(Camera2VideoImageActivity.this, Display_Video_File.class);
                    startPreview();
                    previewVideoFile.putExtra("VideoPath",mVideoFileName);
                    startActivity(previewVideoFile);
    ...
    private File createVideoFileName() throws IOException{
        ...
        Toast.makeText(getApplicationContext(),mVideoFileName,Toast.LENGTH_SHORT).show();
        return videoFile;
    }
